            ...
            <div class="box box-primary">
                        ...
                        <table id="dataList"
                            ...
                            <c:forEach items="${page.list}" var="o">
                                <tr>
                                    ...
                                    <td>xxxx</td>
                                    <td>
                                            <%-- ${o.product.departureTime}--%>
                                        <fmt:formatDate value="${o.product.departureTime}" pattern="yyyy-MM-dd HH:mm"/>
                                    </td>
                                    <td>
                                            <%--${o.orderTime}--%>
                                    ...
                                    <td>
                                        <c:if test="${o.orderStatus == 0}">未处理</c:if>
                                        <c:if test="${o.orderStatus == 1}">已处理</c:if>
                                    </td>
                                    <td>${o.payType}</td>
                                    <td>admin</td>
                ...
                <script>
                    function submitPageNum(num) {
                        location.href = "${pageContext.request.contextPath}/order/getAllOrder.do?pageSize=${page.pageSize}&pageNum="
                            + num;
                    }
                    function changePageSize(ele) {
                        var pageSize = ele.value;
                        location.href = "${pageContext.request.contextPath}/order/getAllOrder.do?pageSize="+pageSize+"&pageNum=${page.pageNum}";
                    }
                </script>
