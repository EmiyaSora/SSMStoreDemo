...
<head>
    ...
    <script type="text/javascript">
        function del() {
            ...
            $("#formID").attr("action", "${pageContext.request.contextPath}/product/delete.do");
            $("#formID").submit();
        }
    </script>
</head>
            ...
            <div class="box box-primary">
                            ...
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default" title="新建"
                                            onclick='location.href="${pageContext.request.contextPath}/product/toAddProduct.do"'>
                        ...
                        <form method="post" id="formID">
                            <table id="dataList"
                                ...
                                <tr>
                                    ...
                                    <th class="sorting">线路价格</th>
                                    <th class="sorting">线路描述</th>
                                ...
                                <tbody>
                                <c:forEach var="p" items="${page.list}" varStatus="vs">
                                    <tr>
                                        ...
                                        <td>
                                                <%--${p.departureTime}--%>
                                            <fmt:formatDate value="${p.departureTime}" pattern="yyyy-MM-dd HH:mm"/>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            <button type="button" class="btn bg-olive btn-xs"
                                                    onclick='location.href="${pageContext.request.contextPath}/product/toUpdate.do?id=${p.id}"'>
                                                修改
                                            </button>
                                            <button type="button" class="btn bg-olive btn-xs"
                ...
                <script>
                    function submitPageNum(num) {
                        location.href = "${pageContext.request.contextPath}/product/getAllProduct.do?pageSize=${page.pageSize}&pageNum="
                            + num;
                    }
                    function changePageSize(ele) {
                        var pageSize = ele.value;
                        location.href = "${pageContext.request.contextPath}/product/getAllProduct.do?pageSize="+pageSize+"&pageNum=${page.pageNum}";
                    }
                </script>
                <!-- .box-footer-->
                <div class="box-footer">
                    <div class="pull-left">
                        <div class="form-group form-inline">
                            总共${page.pages} 页，共${page.total} 条数据。 每页 <select class="form-control" onchange="changePageSize(this)">
